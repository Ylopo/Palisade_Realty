...
```html
<script>
  var YLOPO_HOSTNAME = 'search.palisaderealty.com';
  window.YLOPO_WIDGETS = { domain: 'search.palisaderealty.com' };
</script>
```
...
`https://search.palisaderealty.com/widgets`
...
- **YLOPO domain**: `search.palisaderealty.com`
- **Market**: Las Vegas, NV metro area
- **Widget config page**: `https://search.palisaderealty.com/widgets`
