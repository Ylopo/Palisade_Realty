      ...
      <div className="footer-inner">
        ...
        <div className="footer-col-brand">
          ...
          <div className="footer-social">
            <a href="https://www.facebook.com/palisaderealtysd/" target="_blank" rel="noopener noreferrer" aria-label="Palisade Realty on Facebook">
            ...
            <a href="https://www.instagram.com/palisade.realty/" target="_blank" rel="noopener noreferrer" aria-label="Palisade Realty on Instagram">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
          ...
          <a
            href="https://palisade-realty-academy.thinkific.com/users/sign_in"
            target="_blank"
            rel="noopener noreferrer"
            className="footer-academy-link"
          >
