...
// Scheduled to fire shortly after each FOMC press release (see vercel.json)
...
// (e.g. if the Fed reschedules, or to test against a meeting without waiting
// for that day)
    ...
    html: `
      <div style="font-family:Inter,sans-serif;max-width:600px;margin:0 auto;padding:32px 24px;background:#fff;">
        ...
        <div style="background:#f8f7f4;padding:24px;border-radius:0 0 8px 8px;border:1px solid #e5e3de;border-top:none;">
          ...
          <p style="font-size:14px;color:#1a1a1a;margin:0 0 20px;padding:12px 16px;background:#fff;border-left:3px solid #eeca00;border-radius:4px;">
            <strong>${title}</strong>
          </p>
