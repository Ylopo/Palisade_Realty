...
export default async function AgentPage({ params }: Props) {
  ...
  const email = agent.email ?? SITE_EMAIL_FALLBACK(slug)
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '1320px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
            <a href={toTelUrl(phone)} className="ap-hero-btn ap-hero-btn--ghost">
          ...
          <div style={{ position: 'sticky', top: '96px', background: 'var(--off-white,#faf7f2)', borderRadius: '4px', padding: '28px 24px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '14px' }}>
              ...
              <div>
                ...
                <a href={toTelUrl(phone)} style={{ fontFamily: 'var(--font-body)', fontSize: '15px', fontWeight: 600, color: 'var(--near-black,#1a0a0a)', textDecoration: 'none' }}>{phone}</a>
              </div>
            </div>
        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'start' }}>
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
              {[
                { icon: 'phone', text: phone, href: toTelUrl(phone) },
