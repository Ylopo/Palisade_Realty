...
// per-category blue-leaning scheme, so this page reads consistently with the
// rest of the admin (AdminNav, idea-review, etc).
    ...
    <div style={styles.page}>
      <div style={styles.container}>
        ...
        <div style={styles.header}>
          <div style={styles.headerLabel}>Palisade Realty · Blog Pipeline</div>
          ...
          <div style={styles.progressTrack}>
            {Array.from({ length: MAX_SELECTION }, (_, i) => (
              <div
                ...
                style={{
                  ...styles.progressDot,
                  background: i < selected.size ? BRAND : '#e5e3de',
                }}
              />
            ))}
          </div>
        ...
        <div style={styles.grid}>
          {articles.map((article, index) => {
            ...
            const color = CATEGORY_COLORS[article.category] ?? BRAND
            return (
              <div
                key={article.id}
