...
> = {
  ...
  'review-only':   { label: 'Review Only',   bg: '#fdf2f4', text: BRAND,    border: '#e5b9c4' },
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginTop: 4 }}>
        <button
          ...
          style={{
            background: cardState.phase === 'approving' ? '#c98a9a' : BRAND,
            color: '#fff',
            border: 'none',
            borderRadius: 7,
            padding: '9px 18px',
    ...
    <div style={{ minHeight: '100vh', background: '#f8f7f4', fontFamily: 'Inter, -apple-system, sans-serif' }}>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '32px 16px' }}>
        ...
        <div style={{ marginBottom: 24 }}>
          <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase', color: BRAND, marginBottom: 6 }}>
            Palisade Realty · Content Refresh Queue
          </div>
