...
import type { RefreshCandidate } from '@/lib/refresh-engine'
import type { PerformanceWeights } from '@/lib/idea-store'
import type { FHCheckResult } from '@/lib/fair-housing'
...
<body style="margin:0;padding:0;background:#f8f7f4;font-family:Inter,-apple-system,sans-serif;">
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:12px;border:1px solid #e0ddd8;">
        ...
        <tr>
          <td style="padding: 32px 32px 24px; border-bottom: 1px solid #e0ddd8;">
            <div style="font-size: 11px; font-weight: 700; letter-spacing: 0.14em; text-transform: uppercase; color: #2563eb; margin-bottom: 8px;">Palisade Realty · Daily Blog Digest</div>
        ...
        <tr>
          <td style="padding: 24px 32px; border-top: 1px solid #e0ddd8;">
            <div style="font-size: 11px; color: #888884; text-align: center;">
              Palisade Realty · Automated Blog Pipeline
            </div>
          </td>
        </tr>
  ...
  await resend.emails.send({
    from: fromEmail,
    to: operatorEmail,
    subject: `San Diego Blog Digest — ${articles.length} articles ready to publish (${dateFormatted})`,
    html,
  })
}
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f8f7f4;padding:32px 16px;">
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;background:#ffffff;border-radius:12px;border:1px solid #e0ddd8;">
        <tr>
          <td style="padding:32px 32px 24px;border-bottom:1px solid #e0ddd8;">
            <div style="font-size:11px;font-weight:700;letter-spacing:0.14em;text-transform:uppercase;color:#2563eb;margin-bottom:8px;">Palisade Realty · Market Reports</div>
        ...
        <tr>
          <td style="padding:20px 32px;border-top:1px solid #e0ddd8;">
            <div style="font-size:11px;color:#888884;text-align:center;">Palisade Realty · Automated Market Reports</div>
          </td>
        </tr>
      </table>
    </td></tr>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f8f7f4;padding:32px 16px;">
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:12px;border:1px solid #e0ddd8;">
        ...
        <tr>
          <td style="padding:32px 32px 24px;border-bottom:1px solid #e0ddd8;">
            <div style="font-size:11px;font-weight:700;letter-spacing:0.14em;text-transform:uppercase;color:#2563eb;margin-bottom:8px;">Palisade Realty · Content Refresh Queue</div>
        ...
        <tr>
          <td style="padding:24px 32px;border-top:1px solid #e0ddd8;">
            <div style="font-size:11px;color:#888884;text-align:center;">
              Palisade Realty · Automated Content Refresh Pipeline
            </div>
          </td>
        </tr>
    ...
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:12px;border:2px solid #fca5a5;">
        ...
        <tr>
          <td style="padding:20px 32px;border-top:1px solid #e0ddd8;">
            <div style="font-size:11px;color:#888884;text-align:center;">
              Palisade Realty · Fair Housing Compliance · Automated Alert
            </div>
          </td>
        </tr>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f8f7f4;padding:32px 16px;">
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:12px;border:1px solid #e0ddd8;">
        ...
        <tr>
          <td style="padding:32px 32px 24px;border-bottom:1px solid #e0ddd8;">
            <div style="font-size:11px;font-weight:700;letter-spacing:0.14em;text-transform:uppercase;color:#2563eb;margin-bottom:8px;">Palisade Realty · Bi-Weekly Performance Review</div>
        ...
        <tr>
          <td style="padding:24px 32px;border-top:1px solid #e0ddd8;">
            <div style="font-size:11px;color:#888884;text-align:center;">
              Palisade Realty · Bi-Weekly Performance Review · Automated
            </div>
          </td>
        </tr>
...
export async function sendAEODailyEmail(
  ...
  const resendKey = process.env.RESEND_API_KEY
  const fromEmail = process.env.FROM_EMAIL ?? 'noreply@palisaderealty.com'
  ...
  const pageRows = pages.map(p => `
    <tr>
      ...
      <td style="padding:12px 16px;border-bottom:1px solid #e5e7eb;">
        <a href="https://www.palisaderealty.com${p.url}" style="color:#2563eb;text-decoration:none;">/${p.url.replace(/^\//, '')}</a>
      </td>
    </tr>`).join('')
