...
const PROPERTIES: FeaturedProperty[] = [
  ...
  },
  {
    ...
    lat: 32.7552,
    lng: -117.0993,
    tagline: 'A beautifully updated Kensington Spanish hacienda just north of Adams Avenue, with paid solar and a private rear garden built for entertaining.',
    ...
    features: [
      ...
      'Striking living-room fireplace',
      'Formal living and dining rooms',
      'Breakfast nook',
      'Private rear garden with a second fireplace, ideal for entertaining',
  ...
  {
    slug: 'san-diego-bear-river-row-unit-2',
    address: '6867 Bear River Row Unit 2',
    city: 'San Diego',
    state: 'CA',
    status: 'active',
    hasDetailPage: true,
    listedBy: { agent: 'Deborah Trevino', brokerage: 'Palisade Realty' },
    zip: '92139',
    mls: '260018231',
    price: 499000,
    priceDisplay: '$499,000',
    beds: 2,
    baths: 1,
    sqft: 866,
    yearBuilt: 1980,
    ...
    lat: 32.6887,
    lng: -117.0459,
    tagline: 'Beautifully remodeled end-unit townhouse in Paradise Hills — VA/FHA approved with two private patios and single-level living.',
    description: 'Beautifully remodeled 2 bedroom, 1 bath end unit offering single level living in the desirable Paradise Hills area. VA and FHA approved, making this an excellent opportunity for first time homebuyers, military buyers, and downsizers. This move in ready home features an open concept living and dining area that flows seamlessly to a private patio, creating the perfect indoor outdoor lifestyle. The updated kitchen includes new appliances, ample cabinetry, and pantry storage. Enjoy the convenience of an interior laundry area, central air conditioning, and quality finishes throughout. Enjoy two private patios — the main patio offers a comfortable outdoor entertaining space, while the second private patio is accessible directly from the primary bedroom, providing a peaceful retreat. As an end unit, the home offers added privacy in a quiet, well maintained community. Ideally situated approximately 15 minutes from Downtown San Diego, with easy access to Highway 54, Interstate 5, and Interstate 805, making commuting throughout San Diego County simple.',
    ylopoDetailUrl: 'https://search.palisaderealty.com/search/detail/267731358',
    features: [
      'Beautifully remodeled end unit with single-level living',
      'VA and FHA approved — ideal for first-time and military buyers',
      'Open concept living and dining with private patio access',
      'Updated kitchen with new appliances, ample cabinetry and pantry',
      'Interior laundry and central air conditioning',
      'Two private patios including one off the primary bedroom',
      'Community pool maintained by HOA ($380/mo)',
      'Easy access to Hwy 54, I-5, and I-805',
    ],
    heroImage: 'https://d25fhp1qfwqa2h.cloudfront.net/b2c199110cf8c21e8e779bd9062a681e,1784940894000_auto_650?phid=19579343191',
    gallery: [
      'https://d25fhp1qfwqa2h.cloudfront.net/b2c199110cf8c21e8e779bd9062a681e,1784940894000_auto_650?phid=19579343191',
      'https://d25fhp1qfwqa2h.cloudfront.net/ac4cf9191f9f67472edee38caca5db26,1784940894000_auto_650?phid=19579343192',
      'https://d25fhp1qfwqa2h.cloudfront.net/a76e2df18e36c8ae1bfdd2c19ec872dd,1784940894000_auto_650?phid=19579343193',
    ],
  },
  {
